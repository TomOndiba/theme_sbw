...
<div id="wrapper">
	<header id="header">
		<div class="container">
			<div class="row">
			<div class="logo"><a href="#"><img src="images/logo.png" alt="images"></a></div>
			<div class="right-panel">

				<ul class="flag-list">
				<li><a href="#"><img src="images/flag-1.png" alt="image"></a></li>
				<li><a href="#"><img src="images/flag-2.png" alt="image"></a></li>
				<li><a href="#"><img src="images/flag-3.png" alt="image"></a></li>
				<li><a href="#"><img src="images/flag-4.png" alt="image"></a></li>
				<li><a href="#"><img src="images/flag-5.png" alt="image"></a></li>
				</ul>
	...
	<section class="sign-up">
		<div class="container">
			...
			<li>
				<div class="img-holder">
				<img src="images/img-5.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					groups
			...
			<li>
				<div class="img-holder">
				<img src="images/img-10.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					rss feed import
			...
			<li>
				<div class="img-holder">
				<img src="images/img-11.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					blogs
			...
			<li>
				<div class="img-holder">
				<img src="images/img-12.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					discussions
			...
			<li>
				<div class="img-holder">
				<img src="images/img-13.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					event manager
			...
			<li>
				<div class="img-holder">
				<img src="images/img-14.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					files repository
			...
			<li>
				<div class="img-holder">
				<img src="images/img-15.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					tagging
			...
			<li>
				<div class="img-holder">
				<img src="images/img-16.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					photos
			...
			<li>
				<div class="img-holder">
				<img src="images/img-17.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					pages
			...
			<li>
				<div class="img-holder">
				<img src="images/img-18.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					bookmarks
			...
			<li>
				<div class="img-holder">
				<img src="images/img-19.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					messaging
			...
			<li>
				<div class="img-holder">
				<img src="images/img-20.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					polls
			...
			<li>
				<div class="img-holder">
				<img src="images/img-22.jpg" alt="image">
				<div class="overlay">
					<div class="text">
					videos
			...
			<li>
				<div class="img-holder">
				<img src="images/img-23.jpg" alt="image">
				<div class="overlay">
					<div class="text">
	...
	<section class="our-values">
		<div class="container">
			...
			<div class="column">
				<img src="images/img-25.png" alt="images">
				<div class="text">
				<h3>Free Software</h3>
			...
			<div class="column">
				<img src="images/img-26.png" alt="images">
				<div class="text">
			...
			<div class="column">
				<img src="images/img-27.png" alt="images">
				<div class="text">
				<h3>NETWORKS</h3>
			...
			<div class="column">
				<img src="images/img-28.png" alt="images">
				<div class="text">
				<h3>ETHICS</h3>
			...
			<div class="column">
				<img src="images/img-29.png" alt="images">
				<div class="text">
	...
	<section class="welcome">
		<div class="container">
			...
			<ul class="img-frame">
				<li>
				<a href="images/individuals.jpg" data-lightbox="individuals"><img class="example-image" src="images/individuals.jpg" alt="individuals" /></a>
				</li>
				<li><a href="images/organizations.jpg" data-lightbox="organizations"><img class="example-image" src="images/organizations.jpg" alt="organizations" /></a></li>
				<li><a href="images/groups.jpg" data-lightbox="groups"><img class="example-image" src="images/groups.jpg" alt="groups" /></a></li>
				<li><a href="images/companies.jpg" data-lightbox="companies"><img class="example-image" src="images/companies.jpg" alt="companies" /></a></li>
				<li><a href="images/associations.jpg" data-lightbox="associations"><img class="example-image" src="images/associations.jpg" alt="associations" /></a></li>
				<li><a href="images/institutions.jpg" data-lightbox="institutions"><img class="example-image" src="images/institutions.jpg" alt="image-1" /></a></li>
			</ul>
			</div>
			<div class="comunity-img">
			<img src="images/img-37.jpg" alt="image">
			</div>
		</div>
	</section>
	...
	<footer id="footer">
		<div class="container">
			...
			<div class="footer-logo"><a href="#"><img src="images/footer-logo.png" alt="image"></a></div>
